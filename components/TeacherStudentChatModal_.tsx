...
export const TeacherStudentChatModal: React.FC<
  TeacherStudentChatModalProps
> = ({ open, onClose, teacherId, studentId, studentName }) => {
  ...
  useEffect(() => {
    ...
    const loadMessages = async () => {
      setLoading(true);
      const pairFilter = `and(sender_id.eq.${teacherId},receiver_id.eq.${studentId}),and(sender_id.eq.${studentId},receiver_id.eq.${teacherId})`;
  ...
  async function handleSend(e: React.FormEvent) {
    ...
    try {
      ...
      // you can show a toast or inline error if you like
    } finally {
      setSending(false);
    }
  }
