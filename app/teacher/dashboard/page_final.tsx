...
export default function TeacherDashboardPage() {
  ...
  // Load all sessions for the logged-in teacher
  const loadSessions = React.useCallback(async () => {
    ...
    // Using FK: class_sessions.student_id → profiles.id
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-8">
      ...
      <p className="mt-1 text-sm text-slate-600">
        View your schedule, start/end classes, and add assessments.
      </p>
      ...
      <div className="mt-6 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
        ...
        {!loading && !error && sessions.length === 0 && (
          <p className="mt-4 text-sm text-slate-500">
            No classes found yet. Once admin schedules class_sessions for you,
